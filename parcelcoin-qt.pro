TEMPLATE = app
TARGET = parcelcoin-qt
macx:TARGET = "Parcelcoin-Qt"
VERSION = 1.0
...
QRCODE_INCLUDE_PATH=C:/deps/qrcode-win32-3.1.1/include
QRCODE_LIB_PATH=C:/deps/qrcode-win32-3.1.1/dll
...
macx: {
    ...
    DEFINES += MAC_OSX
    ICON = src/mac/artwork/Parcelcoin.icns
