...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Parcelcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"parcelcoin.com", "seed.parcelcoin.com"},
    {"mophides.com", "seed.mophides.com"},
    {"dglibrary.org", "seed.dglibrary.org"},
//    {"parcelcoinpool.org", "dnsseed.parcelcoinpool.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Parcelcoin is probably already running."), addrBind.ToString().c_str());
        else
